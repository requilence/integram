...
const htmlTemplateDetermineTZ = `<!DOCTYPE html>
<html lang="en">
<head>
<meta charset='utf-8' />
<script type="text/javascript">
// minified jstz: http://pellepim.bitbucket.org/jstz
...
window.location.replace("{{ .redirectURL }}?tz="+encodeURIComponent(tz.name()));
</script>
</head>
<body>
...
const htmlTemplateWebpreview = `<!DOCTYPE html>
<html lang="en" class="">
